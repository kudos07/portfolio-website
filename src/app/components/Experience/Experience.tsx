...
const EXPERIENCES = [
  {
    ...
    location: "Remote, US",
    bullets: [
      "Benchmarked GPT-4, Claude 3.5, Gemini Flash, and DeepSeek V2 on a 250-sample extraction suite, selecting Gemini Flash for best JSON validity and lowest hallucinations.",
      "Built RAG based structured extraction with prompt engineering, few-shot examples, and JSON Schema guardrails, raising parse success from 78% to 96% and reducing hallucinations by 25%.",
      "Ran 50+ versioned experiments in MLflow across model choice, prompt variants, chunking, and retrieval settings for regression tracking.",
      "Implemented FastAPI microservices with async I/O, Celery workers, and Redis queues, sustaining 1,200 to 2,000 records per hour with under 2% timeouts.",
      "Added PostgreSQL persistence and URL caching keyed by prompt version, reducing repeat LLM calls by 35%.",
      "Shipped a React.js + TypeScript directory UI with search, facet filters (county, service tags), and paginated tables.",
    ],
